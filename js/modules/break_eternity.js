(function (global, factory) {
    ...
    var EXP_LIMIT = Number.MAX_SAFE_INTEGER; //If we're ABOVE this value, increase a layer. (9e15 is close to the largest integer that can fit in a Number.)
    var LAYER_DOWN = Math.log10(Number.MAX_SAFE_INTEGER);
    var FIRST_NEG_LAYER = 1 / Number.MAX_SAFE_INTEGER; //At layer 0, smaller non-zero numbers than this become layer 1 numbers with negative mag. After that the pattern continues as normal.
